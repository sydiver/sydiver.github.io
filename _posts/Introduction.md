...
**free index는 합이 일어나지 않는 인덱스**입니다.  
즉, 결과가 어떤 성분(component)인지 “딱 지정해 주는” 역할을 합니다.
...
예를 들어 3차 텐서 $A_{ijk}$와 3차 텐서 $B_{rst}$의 외적은

\[
C_{ijkrst} = A_{ijk}\,B_{rst}
\]

처럼 쓰며, 결과는 6차 텐서가 됩니다.
...
### 1) 완전 반대칭 (totally skew-symmetric)
...
이제 왜 계산이 간단해지는지 감이 오시나요?
대충 느낌만 와도 이해를 잘 하고 계신겁니다.
다음에 이어가겠습니다.
